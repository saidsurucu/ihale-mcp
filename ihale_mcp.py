...
async def search_tenders(
    ...
    yerli_istekliye_fiyat_avantaji_uygulaniyor_mu: Annotated[Optional[bool], "Filter for domestic bidder price advantage applied"] = None,
    ...
    result = await ekap_client.search_tenders(
        ...
        yerli_istekliye_fiyat_avantaji_uygulaniyor_mu=yerli_istekliye_fiyat_avantaji_uygulaniyor_mu,
